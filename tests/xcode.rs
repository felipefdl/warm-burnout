...
fn dark_syntax_colors_match_palette() {
  let expected = [
    ...
    ("xcode.syntax.identifier.function.system", "#f58088"),
    ("xcode.syntax.identifier.type", "#8aa8b8"),
    ("xcode.syntax.identifier.type.system", "#8aa8b8"),
    ("xcode.syntax.identifier.class", "#8aa8b8"),
    ("xcode.syntax.identifier.class.system", "#8aa8b8"),
    ("xcode.syntax.string", "#b4bc78"),
    ("xcode.syntax.character", "#b4bc78"),
    ("xcode.syntax.number", "#d4a8b8"),
    ("xcode.syntax.comment", "#aea195"),
    ("xcode.syntax.comment.doc", "#aea195"),
    ("xcode.syntax.comment.doc.keyword", "#aea195"),
    ...
    ("xcode.syntax.identifier.variable", "#f58088"),
    ("xcode.syntax.identifier.variable.system", "#f58088"),
    ("xcode.syntax.identifier.macro", "#e6c08a"),
    ("xcode.syntax.identifier.macro.system", "#e6c08a"),
    ("xcode.syntax.url", "#8aa8b8"),
    ("xcode.syntax.mark", "#aea195"),
    ("xcode.syntax.declaration.type", "#8aa8b8"),
...
fn light_syntax_colors_match_palette() {
  let expected = [
    ...
    ("xcode.syntax.identifier.function.system", "#a02838"),
    ("xcode.syntax.identifier.type", "#2a5868"),
    ("xcode.syntax.identifier.type.system", "#2a5868"),
    ("xcode.syntax.identifier.class", "#2a5868"),
    ("xcode.syntax.identifier.class.system", "#2a5868"),
    ("xcode.syntax.string", "#4d5c1a"),
    ("xcode.syntax.character", "#4d5c1a"),
    ("xcode.syntax.number", "#7e4060"),
    ("xcode.syntax.comment", "#5a5244"),
    ("xcode.syntax.comment.doc", "#5a5244"),
    ("xcode.syntax.comment.doc.keyword", "#5a5244"),
    ...
    ("xcode.syntax.identifier.variable", "#a02838"),
    ("xcode.syntax.identifier.variable.system", "#a02838"),
    ("xcode.syntax.identifier.macro", "#7a5a1c"),
    ("xcode.syntax.identifier.macro.system", "#7a5a1c"),
    ("xcode.syntax.url", "#2a5868"),
    ("xcode.syntax.mark", "#5a5244"),
    ("xcode.syntax.declaration.type", "#2a5868"),
