;;; warm-burnout-light-theme.el --- Warm Burnout Light theme -*- lexical-binding: t; -*-
...
;; Light variant of Warm Burnout. Fully warm palette, minimal blue-spectrum
;; emission, WCAG AA contrast (>= 4.5:1) for all syntax tokens.
...
(deftheme warm-burnout-light
  "Warm Burnout Light - warm everywhere, blue nowhere.")

(warm-burnout--with-palette warm-burnout-light-palette
  ...
  (custom-theme-set-faces
   ...
   ;; --- Mode-line ---
   `(mode-line ((t (:foreground ,fg :background ,bg-dim :box (:line-width 1 :color ,border)))))
   `(mode-line-inactive ((t (:foreground ,fg-dim :background ,bg-float :box (:line-width 1 :color ,border)))))
   ...
   ;; --- Diff ---
   `(diff-added ((t (:foreground ,added :background "#d2d6be"))))
   `(diff-removed ((t (:foreground ,deleted :background "#eccdc5"))))
   `(diff-changed ((t (:foreground ,modified :background "#d3d7d5"))))
   ...
   `(magit-diff-added ((t (:foreground ,added :background "#d2d6be"))))
   `(magit-diff-added-highlight ((t (:foreground ,added :background "#c0caac"))))
   `(magit-diff-removed ((t (:foreground ,deleted :background "#eccdc5"))))
   `(magit-diff-removed-highlight ((t (:foreground ,deleted :background "#e8bdb7"))))
   `(magit-diff-context ((t (:foreground ,fg-dim))))
   `(magit-diff-context-highlight ((t (:foreground ,fg-dim :background ,bg-highlight))))
   `(magit-diff-hunk-heading ((t (:foreground ,fg :background ,bg-dim))))
   `(magit-diff-hunk-heading-highlight ((t (:foreground ,fg :background ,bg-dim :weight bold))))
   ...
   ;; --- diff-hl ---
   `(diff-hl-insert ((t (:foreground ,added :background "#c0caac"))))
   `(diff-hl-change ((t (:foreground ,modified :background "#c1cbcf"))))
   `(diff-hl-delete ((t (:foreground ,deleted :background "#e8bdb7"))))
   ...
   ;; --- Ediff ---
   `(ediff-current-diff-A ((t (:background "#eccdc5"))))
   `(ediff-current-diff-B ((t (:background "#d2d6be"))))
   `(ediff-current-diff-C ((t (:background "#d3d7d5"))))
   `(ediff-current-diff-Ancestor ((t (:background ,bg-highlight))))
   `(ediff-fine-diff-A ((t (:background "#e8bdb7" :weight bold))))
   `(ediff-fine-diff-B ((t (:background "#c0caac" :weight bold))))
   `(ediff-fine-diff-C ((t (:background "#c1cbcf" :weight bold))))
...
(provide-theme 'warm-burnout-light)
;;; warm-burnout-light-theme.el ends here
